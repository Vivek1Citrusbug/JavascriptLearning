...
function showUser(n: number): void {
  ...
  (document.getElementById("userTitle") as HTMLElement).innerHTML =
    "User: " + userData.userID;
  (document.getElementById("name_input") as HTMLInputElement).value =
    userData.name || "";
  ...
  const genderRadioButtons = document.getElementsByName(
    "genderradio"
...
function updateUser(index: number): void {
  const updatedUser = {
    ...
    contact: (document.getElementById("contactNumber") as HTMLInputElement)
      .value,
...
function validation(user: {
  ...
  const error_message_name = document.getElementById(
    "name-error"
  ) as HTMLElement;
  const error_message_email = document.getElementById(
    "email-error"
  ) as HTMLElement;
  const error_message_contact = document.getElementById(
    "contact-error"
  ) as HTMLElement;
  const error_message_zipcode = document.getElementById(
    "zipcode-error"
  ) as HTMLElement;
  const error_message_birthdate = document.getElementById(
    "birthdate-error"
  ) as HTMLElement;
  const error_message_gender = document.getElementById(
    "gender-error"
  ) as HTMLElement;
  const error_message_hobbies = document.getElementById(
    "hobbies-error"
  ) as HTMLElement;
  const error_message_technology = document.getElementById(
    "technology-error"
  ) as HTMLElement;
  ...
  const username = (document.getElementById("name_input") as HTMLInputElement)
    .value;
  ...
  const getGender = document.querySelector(
    'input[name="genderradio"]:checked'
  ) as HTMLInputElement;
  const getHobbies = document.querySelectorAll(
    'input[name="hobbies"]:checked'
  ) as NodeListOf<HTMLInputElement>;
  const technologySelect = document.getElementById(
    "technology"
  ) as HTMLSelectElement;
  const selectedTechnology = Array.from(technologySelect.selectedOptions).map(
    (option) => option.value
  );
